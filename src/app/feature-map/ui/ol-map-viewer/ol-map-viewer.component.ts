...
@Component({
  selector: 'app-ol-map-viewer',
  templateUrl: './ol-map-viewer.component.html',
  styleUrls: ['./ol-map-viewer.component.scss']
})
export class OlMapViewerComponent implements OnInit, AfterViewInit, MapViewer {
